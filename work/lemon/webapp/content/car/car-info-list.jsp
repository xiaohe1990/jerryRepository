...
<div class="panel panel-default">
  <div class="panel-heading">
	...
	<div class="pull-right ctrl">
	  <a class="btn btn-default btn-xs"><i id="car-infoSearchIcon" class="glyphicon glyphicon-chevron-up"></i></a>
    </div>
  </div>
  <div class="panel-body">
		  ...
		  <form name="car-infoForm" method="post" action="car-info-list.do" class="form-inline">
		    ...
		    <input type="text" id="car-info_name" name="filter_LIKES_name" value="${param.filter_LIKES_name}" class="form-control">
			<button class="btn btn-default a-search" onclick="document.car-infoForm.submit()">查询</button>&nbsp;
		  </form>
      ...
      <div style="margin-bottom: 20px;">
	    <div class="pull-left btn-group" role="group">
		  <button class="btn btn-default a-insert" onclick="location.href='car-info-input.do'">新建</button>
...
<form id="car-infoGridForm" name="car-infoGridForm" method='post' action="car-info-remove.do" class="m-form-blank">
  ...
  <table id="car-infoGrid" class="table table-hover">
    <thead>
      <tr>
