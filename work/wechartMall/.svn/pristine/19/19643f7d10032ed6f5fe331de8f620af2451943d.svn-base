			...
			<div class="row">
				...
				<div class="col-md-10">
					...
					<form id="formId" enctype="multipart/form-data" action="${basePath}/user/updateSelf.shtml" method="post">
						  ...
						  <div class="form-group">
						    <label for="username">帐号（不准修改）</label>
						    <input type="text" class="form-control " disabled autocomplete="off" id="username" maxlength="64" name="username" value="${token.username?default('未设置')}" placeholder="请输入帐号">
						  </div>
						  <div class="form-group">
						    <label for="phonenum">手机号（暂不支持修改）</label>
						    <input type="text" class="form-control " disabled autocomplete="off" id="phonenum" maxlength="64" name="phonenum" value="${token.phonenum?default('未设置')}" placeholder="请输入帐号">
						  </div>
						  <div class="form-group">
						    <label for="email">Email（暂不支持修改）</label>
