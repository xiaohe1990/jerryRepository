package com.mall.core.statics;

import java.util.Calendar;

import com.mall.core.config.IConfig;
...
public interface Constant {
	...
	final static String  EXECUTE_CHANGE_USER = "mall_EXECUTE_CHANGE_USER";
	
	//登录方式，如帐号，手机号，邮箱登录
	final static String LOGIN_UNAME = "username";
	final static String LOGIN_PHONE = "phonenum";
