...
<html lang="zh-cn">
	<head>
		...
		<link href="<%=basePath%>/sys/js/common/bootstrap/3.3.5/sys/css/bootstrap.min.css" rel="stylesheet"/>
		<link href="<%=basePath%>/sys/css/common/base.css" rel="stylesheet"/>
		<script  src="<%=basePath%>/sys/js/common/jquery/jquery1.8.3.min.js"></script>
		<script  src="<%=basePath%>/sys/js/common/layer/layer.js"></script>
		<script  src="<%=basePath%>/sys/js/common/bootstrap/3.3.5/js/bootstrap.min.js"></script>
