...
import com.mall.common.dao.UUserMapper;
import com.mall.common.dao.UUserRoleMapper;
import com.mall.common.model.UUser;
import com.mall.common.model.UUserRole;
import com.mall.common.utils.LoggerUtils;
import com.mall.core.mybatis.BaseMybatisDao;
import com.mall.core.mybatis.page.Pagination;
import com.mall.core.shiro.session.CustomSessionManager;
import com.mall.core.shiro.token.manager.TokenManager;
import com.mall.permission.bo.URoleBo;
import com.mall.permission.bo.UserRoleAllocationBo;
...
public class UUserServiceImpl extends BaseMybatisDao<UUserMapper> implements UUserService {
	...
	@Override
	public UUser login(UUser uuser) {
		/*Map<String,Object> map = new HashMap<String, Object>();
		map.put("email", email);
		map.put("pswd", pswd);*/
		UUser user = userMapper.login(uuser);
		return user;
	}
