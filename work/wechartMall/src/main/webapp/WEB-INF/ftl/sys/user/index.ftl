      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
      	<#if menulist?exists && menulist?size gt 0 >
	        ...
	        <li class="layui-nav-item layui-nav-itemed">
	         ...
	         <#if menu.permissionList?exists && menu.permissionList?size gt 0>
	          <dl class="layui-nav-child">
	          	<#list menu.permissionList as mes >
	            <dd><a href="javascript:tabAdd('${mes.name}','${basePath}${mes.url}',${mes.id});">${mes.name}</a></dd>
	          	</#list>
	          </dl>
	          </#if>
	        </li>
