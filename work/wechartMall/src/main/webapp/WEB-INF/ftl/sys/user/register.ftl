    ...
    <body id="body">
        <div class="page-container" style="margin: 100px auto 0px;">
            ...
            <form id="_form" action="" method="post">
                ...
                <input type="text" name="username"  id="username" placeholder="登录帐号">
                ...
                <input type="password" id="re_password"  placeholder="重新输入密码">
        ...
        <script >
			jQuery(document).ready(function() {
			    ...
			    $('.register').click(function(){
			    	...
			    	var email = $("#email").val();
			    	var regUsername=/^[a-zA-Z]\w{3,15}$/;
			    	var regEmail = /.+@.+\.[a-zA-Z]{2,4}$/;
			    	var regPhone = /^1\d{10}$/;
			    	
			    	if(!regUsername.test(username)){
			    		return layer.msg('用户名不合法，必须为4~16位字母或数字！',function(){}),!1;
			    	}
			    	
			    	if(!regEmail.test(email)){
			    		return layer.msg('邮箱输入不合法！',function(){}),!1;
			    	}
			    	
			    	if(!regPhone.test(phonenum)){
			    		return layer.msg('手机号输入不合法！',function(){}),!1;
			    	}
